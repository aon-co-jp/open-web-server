...
## خادم ويب مبني بلغة Rust باستخدام tokio/hyper، مصمم كي لا تُفقد العناصر المدفوعة والبيانات المالية أبدًا
...
ببطاقات الائتمان. مبني بلغة **Rust باستخدام tokio/hyper** (شكل واجهة التوجيه/المعالجات
متوافق مع تطبيق Poem السابق، لكن الحزمة لم تعد تعتمد على Poem منذ 2026-07-10)، ويعمل جنبًا إلى جنب مع
...
`open-web-server-ledger` (WAL متكافئ + التزام عبر 3 قفزات)، `open-web-server-gateway` (بوابة tokio/hyper، بدون اعتماد على Poem).
